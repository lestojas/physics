...
# ---------------------------------------------------------------- data
# (rank, [ (name, section, score) ... ])  -- Summative Test 2
GROUPS = [
    (1, [("Roan Krezil L. Castillo",      "Edison",  28)]),
    (2, [("Nyl O. Bondalo",               "Edison",  26),
         ("Cyril Joel Amir C. Olivares",  "Maxwell", 26),
         ("Kylie D. Sabino",              "Maxwell", 26),
         ("Athena B. Tambalila",          "Maxwell", 26)]),
    (3, [("Jessielou Sarias",             "Edison",  25),
         ("Ni\u00f1a Meriel O. Sosme\u00f1a", "Tesla", 25)]),
    (4, [("Linz Jerry L. Abela",          "Edison",  24),
         ("Kristia Ann O. Eviota",        "Maxwell", 24),
         ("Carsten Jace L. Putian",       "Maxwell", 24),
         ("Andy Jr. M. Tabunan",          "Edison",  24)]),
    (5, [("Andrei Rafael Alay",           "Edison",  23),
         ("Kobe Bryele S. Gabonada",      "Edison",  23),
         ("Edvincent B. Mi\u00f1oza",     "Edison",  23),
         ("Tisha Denn L. Paca\u00f1a",    "Maxwell", 23)]),
]
MAX_SCORE = 30
...
tb = d.textbbox((0, 0), "Summative Test 2", font=f_test)
...
out.save("/projects/sandbox/physics/top_scorers_test2.png")
