...
EXAMPLES.append(dict(
    ...
    blocks=[
        ...
        ("part", "Part (a).", "Substitute `v_{0}` = 0, `a` = \u22129.81 m/s\u00b2, `t` = 1.90 s:"),
        ("eq", [("y \u2212 0", "= 0 + \\frac{1}{2}(\u22129.81){(1.90)}^{2}"),
                ("y", "= \u221217.7 \\u{m}")]),
...
EXAMPLES.append(dict(
    ...
    blocks=[
        ...
        ("part", "Part (b).", "Substitute `v_{0}` = \u22128.00 m/s, `a` = \u22129.81 m/s\u00b2, "
                             "`y` = \u22128.00 m:"),
        ("eq", [("v^{2}", "= {(\u22128.00)}^{2} + 2(\u22129.81)(\u22128.00 \u2212 0)"),
                ("", "= 64.0 + 156.96"),
                ("", "= 220.96"),
                ("v", "= \u00b114.9 \\u{m/s}")]),
...
EXAMPLES.append(dict(
    ...
    blocks=[
        ...
        ("eq", [("v^{2}", "= v_{0}^{2} + 2a(y \u2212 y_{0})")]),
        ("part", "Part (a).", "Substitute `v_{0}` = 9.50 m/s, `a` = \u22129.81 m/s\u00b2, "
                             "`y` = 3.60 m:"),
        ("eq", [("v^{2}", "= {(9.50)}^{2} + 2(\u22129.81)(3.60)"),
                ("", "= 90.25 \u2212 70.632"),
                ("", "= 19.62"),
                ("v", "= \u00b14.43 \\u{m/s}")]),
        ...
        ("eq", [("y", "= v_{0}t + \\frac{1}{2}at^{2}")]),
        ("text", "Substitute `y` = 3.60 m, `v_{0}` = 9.50 m/s, `a` = \u22129.81 m/s\u00b2, "
                 "and rearrange into standard quadratic form:"),
        ("eq", [("4.905t^{2} \u2212 9.50t + 3.60", "= 0")]),
        ("text", "Solve with the quadratic formula:"),
        ("eq", [("t", "= \\frac{9.50 \u00b1 \\sqrt{{9.50}^{2} \u2212 4(4.905)(3.60)}}{2 \u00d7 4.905}"
                      " = \\frac{9.50 \u00b1 4.43}{9.81}")]),
...
EXAMPLES.append(dict(
    ...
    blocks=[
        ...
        ("eq", [("0", "= {(17.7)}^{2} + 2(\u22129.81)(h)"),
                ("h", "= \\frac{{(17.7)}^{2}}{2 \u00d7 9.81} = \\frac{311.8}{19.62}"),
                ("h", "= 15.9 \\u{m}")]),
