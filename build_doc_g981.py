...
EXAMPLES.append(dict(
    ...
    problem=("A brick is dropped (zero initial speed) from the roof of a building. "
             ...
             "the ground?"),
    given=[("a = \u22129.81 \\u{m/s}^{2}", "free-fall acceleration; up is +y"),
    ...
    blocks=[
        ...
        ("part", "Part (a).", "Isolate `y`, then substitute `v_{0}` = 0, `a` = \u22129.81 m/s\u00b2, "
                             "`t` = 1.90 s:"),
        ("eq", [("y", "= y_{0} + v_{0}t + \\frac{1}{2}at^{2}"),
                ("y", "= 0 + (0)(1.90) + \\frac{1}{2}(\u22129.81){(1.90)}^{2}")]),
        ("tip", ["The answer is negative because the brick ends up below where it started "
                 ...
                 "size of the number, 17.71 m, and drop the minus sign."]),
        ("answer", "Part (A)", [("\\u{height}", "= 17.71 \\u{m}")]),
        ("step", "Step 2.", "Find the impact velocity with the velocity equation "
                            "`v = v_{0} + at`, which is already solved for `v`."),
        ("eq", [("v", "= v_{0} + at")]),
        ("part", "Part (b).", "Substitute `v_{0}` = 0, `a` = \u22129.81 m/s\u00b2, `t` = 1.90 s:"),
        ("eq", [("v", "= 0 + (\u22129.81)(1.90)")]),
...
EXAMPLES.append(dict(
    ...
    given=[("v_{0} = \u22128.00 \\u{m/s}", "thrown downward \u21d2 negative (up is +)"),
           ("a = \u22129.81 \\u{m/s}^{2}", "free-fall acceleration points down"),
    ...
    blocks=[
        ...
        ("eq", [("y", "= v_{0}t + \\frac{1}{2}at^{2}"),
                ("v", "= v_{0} + at")]),
        ("part", "Part (a).", "Substitute `v_{0}` = \u22128.00 m/s, `a` = \u22129.81 m/s\u00b2, "
                             "`t` = 1.50 s:"),
        ("eq", [("y", "= (\u22128.00)(1.50) + \\frac{1}{2}(\u22129.81){(1.50)}^{2}")]),
        ("eq", [("v", "= \u22128.00 + (\u22129.81)(1.50)")]),
        ...
        ("part", "Part (b).", "Solve for `v` (take the square root), then substitute "
                             "`v_{0}` = \u22128.00 m/s, `a` = \u22129.81 m/s\u00b2, `y` = \u22128.00 m:"),
        ("eq", [("v", "= \u00b1\\sqrt{v_{0}^{2} + 2a(y \u2212 y_{0})}"),
                ("v", "= \u00b1\\sqrt{{(\u22128.00)}^{2} + 2(\u22129.81)(\u22128.00 \u2212 0)}")]),
...
EXAMPLES.append(dict(
    ...
    given=[("v_{0} = +9.50 \\u{m/s}", "thrown upward = positive"),
           ("a = \u22129.81 \\u{m/s}^{2}", "free-fall acceleration"),
    ...
    blocks=[
        ...
        ("part", "Part (a).", "Solve for `v` (take the square root), then substitute "
                             "`v_{0}` = 9.50 m/s, `a` = \u22129.81 m/s\u00b2, `y` = 3.60 m:"),
        ("eq", [("v", "= \u00b1\\sqrt{v_{0}^{2} + 2a(y \u2212 y_{0})}"),
                ("v", "= \u00b1\\sqrt{{(9.50)}^{2} + 2(\u22129.81)(3.60)}")]),
        ("tip", ["Again a \u00b1 answer, so reason about direction. The highest the putty "
                 ...
                 "when it hits. Keep the positive root: v = +4.43 m/s."]),
        ("answer", "Part (A)", [("\\u{speed}", "= 4.43 \\u{m/s}")]),
        ...
        ("text", "Substitute `v_{0}` = 9.50 m/s, `a` = \u22129.81 m/s\u00b2, `y` = 3.60 m:"),
        ("eq", [("t", "= \\frac{\u22129.50 \u00b1 \\sqrt{{(9.50)}^{2} + 2(\u22129.81)(3.60)}}{\u22129.81}")]),
...
EXAMPLES.append(dict(
    ...
    blocks=[
        ...
        ("text", "Substitute `a` = \u22129.81 m/s\u00b2 and `t_{up}` = 1.80 s:"),
        ("eq", [("h", "= \u2212\\frac{1}{2}(\u22129.81){(1.80)}^{2}")]),
        ("answer", "", [("\\u{maximum height}", "= 15.89 \\u{m}")]),
    ]))
...
def build_body():
    ...
    body.append(para(inline_seq("Each example uses `g` = 9.81 m/s\u00b2 for the free-fall "
...
if __name__ == "__main__":
    write_docx("/projects/sandbox/physics/Guided-Examples-Free-Fall-g9.81.docx")
